package com.example.day9cw3.model;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class AmruthaVillage {
    @Id
    ...
    public AmruthaVillage(){}
    public AmruthaVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
