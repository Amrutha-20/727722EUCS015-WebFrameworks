...
public class AmruthaChildren {
    ...
    public AmruthaChildren() {
    }
    public AmruthaChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
