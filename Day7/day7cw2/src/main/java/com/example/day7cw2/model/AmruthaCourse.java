...
public class AmruthaCourse {
    ...
    public AmruthaCourse(){}
    public AmruthaCourse(int courseId, String courseName, int creditHours, String instructor, String preRequisites,
